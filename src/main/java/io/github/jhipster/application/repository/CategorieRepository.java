...
public interface CategorieRepository extends JpaRepository<Categorie, Long> {
    ...
    @Query(value = "select distinct categorie from Categorie categorie left join fetch categorie.criteria",
    ...
    @Query("select categorie from Categorie categorie left join fetch categorie.criteria where categorie.id =:id")
