...
import io.github.jhipster.application.domain.Weight;
import io.github.jhipster.application.repository.WeightRepository;
...
public class WeightResourceIntTest {
    ...
    private static final Integer DEFAULT_QTY_RATION = 1;
    private static final Integer UPDATED_QTY_RATION = 2;

    private static final Integer DEFAULT_NB_RATION = 1;
    private static final Integer UPDATED_NB_RATION = 2;
    ...
    public static Weight createEntity(EntityManager em) {
        Weight weight = new Weight()
            ...
            .qtyRation(DEFAULT_QTY_RATION)
            .nbRation(DEFAULT_NB_RATION)
    ...
    public void createWeight() throws Exception {
        ...
        assertThat(testWeight.getQtyRation()).isEqualTo(DEFAULT_QTY_RATION);
        assertThat(testWeight.getNbRation()).isEqualTo(DEFAULT_NB_RATION);
    ...
    public void getAllWeights() throws Exception {
        ...
        restWeightMockMvc.perform(get("/api/weights?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].qtyRation").value(hasItem(DEFAULT_QTY_RATION)))
            .andExpect(jsonPath("$.[*].nbRation").value(hasItem(DEFAULT_NB_RATION)))
    ...
    public void getWeight() throws Exception {
        ...
        restWeightMockMvc.perform(get("/api/weights/{id}", weight.getId()))
            ...
            .andExpect(jsonPath("$.qtyRation").value(DEFAULT_QTY_RATION))
            .andExpect(jsonPath("$.nbRation").value(DEFAULT_NB_RATION))
    ...
    public void updateWeight() throws Exception {
        ...
        updatedWeight
            ...
            .qtyRation(UPDATED_QTY_RATION)
            .nbRation(UPDATED_NB_RATION)
        ...
        assertThat(testWeight.getQtyRation()).isEqualTo(UPDATED_QTY_RATION);
        assertThat(testWeight.getNbRation()).isEqualTo(UPDATED_NB_RATION);
